...
Hint. Use the method isinstance to check if a value is of class tuple or a str, and solve (b) using a recursive function. Collect all leaf labels in a list, and check if all leaves are distinct by converting to set.
